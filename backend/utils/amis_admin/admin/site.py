...
from utils.amis_admin.admin import AdminApp, admin
from utils.amis_admin.admin.settings import Settings
from utils.amis_admin.amis.components import Page, PageSchema, Property
        ...
        page.body = [
            ...
            Property(
                ...
                items=[
                    ...
                    Property.Item(label="version", content=utils.amis_admin.__version__),
