...
from utils.amis_admin.amis import AmisNode
...
from utils.amis_admin.amis.constants import LabelEnum
from utils.amis_admin.models.enums import Choices
...
class AmisParser:
    ...
    def _get_form_item_from_kwargs(self, modelfield: ModelField, is_filter: bool = False) -> FormItem:
        ...
        if issubclass(modelfield.type_, (list, set)) or (modelfield.outer_type_ and get_origin(modelfield.outer_type_) in {list, set}):
